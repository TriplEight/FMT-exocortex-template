...
- [ ] **>80 строк → `##`/`###` заголовки:** Если документ будет >80 строк — СРАЗУ структурировать секциями (никаких HTML-тегов, Obsidian их ломает). НЕ откладывать «на потом». Proposals, спецификации, архитектурные документы — почти всегда >80 строк.
